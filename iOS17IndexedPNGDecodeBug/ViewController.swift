...
class ViewController: UIViewController {
    ...
    @objc private func testButtonEvent(button: UIButton) {
    ...
    private func setupSubviews(in box: UIView) {
        ...
        NSLayoutConstraint.activate([
            testButton.centerXAnchor.constraint(equalTo: box.centerXAnchor, constant: 0.0),
            testButton.centerYAnchor.constraint(equalTo: box.centerYAnchor, constant: 0.0),
        ])
    }
    ...
    private lazy var testButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(testButtonEvent(button:)), for: .touchUpInside)
        return button
    }()
